    ...
    <div class="detail-header">
      <div class="toolbar">
        ...
        <div class="toolbar__nav">
          ...
          <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
            ...
            <li><a class="dropdown-item" href="#" @click.prevent="showDeleteDialog"><i class="bi bi-trash me-1"></i>
                Delete</a></li>
          </ul>
        </div>
      </div>
      ...
      <div class="info" v-if="!loading">
        ...
        <div class="d-flex align-items-center justify-content-between">
          ...
          <div class="info__notif" data-bs-toggle="tooltip" data-bs-placement="bottom" data-bs-title="Reminder time">
